...
def change_direction(e):
    ...
    if ((e.keysym == "Up" or e.keysym == "w") and velocityY != 1):
        ...
        velocityX = -1
        velocityY = 0
    elif ((e.keysym == "Right" or e.keysym == "d") and velocityX != -1): # Right
        velocityX = 1
        velocityY = 0
...
def draw():
    ...
    if game_over:
        canvas.create_text(WINDOW_WIDTH/2, WINDOW_HEIGHT/2, fill="white", font="Arial 20 bold", text=f"Game Over! Score: {score}")
    else:
